        ...
        <div class="row">
            ...
            <h1 class="my-5 corp" >Доставка и оплата</h1>
                ...
                <section class="text-with-summary text-with-summary-1">
                    ...
                    <p>Доставка осуществляется по Бишкеку и ближайшему пригороду.</p>
                    <p>Если вам удобнее забрать букет самостоятельно, вы можете приехать к нам в офис.</p>
                    <p>Внимание! Мы принимаем заказы до 17:00 текущего дня, доставка осуществляется на следующий день.</p>
                </section>
        </div>
        <div class="row">
